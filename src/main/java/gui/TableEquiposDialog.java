 ...
 * @author Mariano
 */
public class TableEquiposDialog extends javax.swing.JDialog {

    /**
     * Creates new form TableTiposEquiposDialog
     */
    public TableEquiposDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableEquiposDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TableEquiposDialog dialog = new TableEquiposDialog(new javax.swing.JFrame(), true);
