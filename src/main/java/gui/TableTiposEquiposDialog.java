...
public class TableTiposEquiposDialog extends javax.swing.JDialog {
     ...
     */
    public TableTiposEquiposDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableTiposEquiposDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TableTiposEquiposDialog dialog = new TableTiposEquiposDialog(new javax.swing.JFrame(), true);
