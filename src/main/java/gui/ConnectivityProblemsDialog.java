...
public class ConnectivityProblemsDialog extends javax.swing.JDialog {
     ...
     */
    public ConnectivityProblemsDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Problemas de conexion");
        jLabel1.setHorizontalTextPosition(javax.swing.SwingConstants.CENTER);

        jTextArea1.setColumns(20);
        jTextArea1.setRows(5);
        jTextArea1.setEditable(false);
        jTextArea1.setText("Primera línea de texto.Segunda línea de texto.Tercera línea de texto.");
