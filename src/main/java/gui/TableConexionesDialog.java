...
public class TableConexionesDialog extends javax.swing.JDialog {
     ...
     */
    public TableConexionesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableConexionesDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TableConexionesDialog dialog = new TableConexionesDialog(new javax.swing.JFrame(), true);
