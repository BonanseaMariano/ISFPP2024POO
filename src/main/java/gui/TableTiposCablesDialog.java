...
public class TableTiposCablesDialog extends javax.swing.JDialog {
     ...
     */
    public TableTiposCablesDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TableTiposCablesDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                TableTiposCablesDialog dialog = new TableTiposCablesDialog(new javax.swing.JFrame(), true);
