...
2. [Instrucciones de Instalación y Ejecución](#instrucciones-de-instalación-y-ejecución)
    ...
    3. [Modificar el Archivo de Configuración](#3-modificar-el-archivo-de-configuración)
    ...
    6. [Interfaz Gráfica](#6-interfaz-gráfica)
        1. [Activar/Desactivar Modo Simulación](#61-activar-desactivar-modo-simulacion)
...
las funcionalidades disponibles:<br>
![Manual_Usuario_PantallaPrincipalGUI.png](Manual%20de%20usuario%2FManual_Usuario_PantallaPrincipalGUI.png)<br>

- ### 6.1 Activar Desactivar Modo Simulacion

Estando en la pantalla principal para cambiar del modo simulación al modo normal primero debemos dirigirnos
a la parte superior izquierda en donde dice modo.<br>
![Manual_Usuario_ModoSimulacionPaso1.png](Manual%20de%20usuario%2FManual_Usuario_ModoSimulacionPaso1.png)<br>
Una vez hecho esto nos saldra un checkbox que dice "Simulacion", lo apretamos y con eso ya cambiarimos el modo.<br>
![Manual_Usuario_ModoSimulacionPaso2.png](Manual%20de%20usuario%2FManual_Usuario_ModoSimulacionPaso2.png)<br>
...
boton que dice
Equipos en el lado derecho de la ventana como indica la siguiente imagen<br>
![Manual_Usuario_EquipoABM.png](Manual%20de%20usuario%2FManual_Usuario_EquipoABM.png)<br>

Una vez hecho esto se abrira la siguiente ventana<br>
...
- ### 6.2.1 Agregar un Equipo
  ...
  Este boton nos abrira otra ventana como la siguiente donde podremos agregar la informacion de nuestro equipo.<br>
  ![Manual_Usuario_EquipoAgregarPaso2.png](Manual%20de%20usuario%2FManual_Usuario_EquipoAgregarPaso2.png)<br>
  Una vez ingresados los datos de nuestro equipo apretamos en el boton que dice "Aceptar".<br>
  ![Manual_Usuario_EquipoAgregarPaso3.png](Manual%20de%20usuario%2FManual_Usuario_EquipoAgregarPaso3.png)<br>
  Si el equipo se pudo agregar correctamente mostrara el siguiente mensaje, le damos al boton de "OK".<br>
...
- ### 6.2.2 Modificar un Equipo
  ...
  equipo que deseamos modificar y a continuacion apretar el boton que dice "Modificar" en la parte posterior
  central.<br>
  ![Manual_Usuario_EquipoModificarPaso1.png](Manual%20de%20usuario%2FManual_Usuario_EquipoModificarPaso1.png)<br>
  Esto nos abrira una ventana como la siguiente donde podremos modificar todos los datos del equipo salvo por el
  codigo.<br>
  ![Manual_Usuario_EquipoModificarPaso2.png](Manual%20de%20usuario%2FManual_Usuario_EquipoModificarPaso2.png)<br>
  Una vez modificados los datos apretamos el boton de "Aceptar" para confirmar la modificacion.<br>
...
- ### 6.2.3 Borrar un Equipo
  ...
  Esta accion nos mostrara un cartel para confirmar la eliminacion del equipo, le damos click al boton que dice "
  YES".<br>
...
- ### 6.2.4 ABM de puertos de un equipo
  ...
  seleccionar sobre la casilla que dice "Ver puertos" en la columna de "Puertos del equipo".<br>
  ![Manual_Usuario_EquipoAgregarPuertoPaso1.png](Manual%20de%20usuario%2FManual_Usuario_EquipoAgregarPuertoPaso1.png)<br>
  Esta accion nos abrira una ventana como la siguiente donde podremos realizar la accion deseada.<br>
...
- ### 6.2.4.1 Agregar un puerto a un equipo
  ...
  una vez cargados los campos apretamos en el boton que dice "OK" para agregarlo.<br>
...
- ### 6.2.4.2 Borrar un puerto de un equipo
  ...
  derecha y apretar el boton que dice "Borrar".<br>
  ![Manual_Usuario_EquipoBorrarPuertoPaso1.png](Manual%20de%20usuario%2FManual_Usuario_EquipoBorrarPuertoPaso1.png)<br>
  Esto nos abrira una nueva ventana pidiendonos confirmar la eliminacion del puerto y le damos click a "YES".<br>
  ...
  donde le haremos click al boton de "OK" para cerrarla.<br>
...
- ### 6.2.4.3 Modificar un puerto de un equipo
  ...
  , una vez hecho esto deberemos dirigirnos a la parte inferior central y apretar el boton que dice "Modificar".<br>
  ...
  puertos, una vez modificados apretamos en el boton que dice "OK" para completar la acción.<br>
...
- ### 6.2.5 ABM de IPs de un equipo
  ...
  seleccionar sobre la casilla que dice "Ver ips" en la columna de "ips del equipo".<br>
...
- ### 6.2.5.1 Agregar una ip a un equipo
  ...
  cada tres numeros (Ej: 255.255.255.255), una vez escrita la ip apretamos en el boton que dice "OK" para agregarla.<br>
...
- ### 6.2.5.2 Borrar una ip de un equipo
  ...
  Esto nos abrira una nueva ventana pidiendonos confirmar la eliminacion de la ip y le damos click a "YES".<br>
  ...
  haremos click al boton de "OK" para cerrarla.<br>
...
- ### 6.2.5.3 Modificar una ip de un equipo
  ...
  modificada apretamos en el boton que dice "OK" para completar la acción.<br>
...
- ### 6.3 ABM para Conexiones
  ...
  el boton que dice
  "Conexion" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.3.1 Agregar una conexion
  ...
  una vez puesta esta informacion apretamos en el boton que dice "OK" para agregarla.<br>
...
- ### 6.3.2 Borrar una conexion
  ...
  le haremos click al boton de "OK" para cerrarla.<br>
...
- ### 6.3.2 Modificar una conexion
  ...
  fila de la conexion
  que deseamos modificar y a continuacion apretar el boton que dice "Modificar" en la parte posterior central.<br>
  ...
  apretamos el boton que dice "OK" para confirmar el cambio.<br>
...
- ### 6.4 ABM para Tipos de Equipos
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Tipos de equipos" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.4.1 Agregar un Tipo de Equipo
  ...
  una vez escrita esta informacion apretamos en el boton que dice "OK" para agregarlo.<br>
...
- ### 6.4.2 Borrar un Tipo de Equipo
  ...
  Esto nos abrira una nueva ventana pidiendonos confirmar la eliminacion del tipo de equipo y le damos click a "
  YES".<br>
...
- ### 6.5 ABM para Tipos de Cables
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Tipos de cables" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.5.2 Borrar un Tipo de Cable
  ...
  Esto nos abrira una nueva ventana pidiendonos confirmar la eliminacion del tipo de cable y le damos click a "YES".<br>
  ![Manual_Usuario_TipoCableBorrarPaso1.png](Manual%20de%20usuario%2FManual_Usuario_TipoCableBorrarPaso1.png)<br>
...
- ### 6.6 ABM para Ubicaciones
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Ubicaciones" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.6.1 Agregar una Ubicacion
  ...
  una vez escrita esta informacion apretamos en el boton que dice "OK" para agregarla.<br>
...
- ### 6.6.2 Borrar una Ubicacion
  ...
  Esto nos abrira una nueva ventana pidiendonos confirmar la eliminacion de la ubicacion y le damos click a "OK".<br>
...
- ### 6.7 ABM para Tipos de Puertos
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Tipos de puertos" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.8.1 Ruta entre dos Equipos modo Simulasion
  ...
  saber la ruta y clickeamos el boton que dice "Buscar".<br>
  ...
  ruta entre ambos equipos (si esta existe, si no mostrara un cartel que especifica que no hay ruta entre ambos)<br>
...
- ### 6.9.1 Ping a una IP modo Simulasion
  ...
  le damos click al boton que dice "ping".<br>
...
- ### 6.9.2 Ping a una IP modo Real
  ...
  hacer ping e indicar la cantidad de pings a realizar.<br>
  ![Manual_Usuario_PingIPPaso2Real.png](Manual%20de%20usuario%2FManual_Usuario_PingIPPaso2Real.png)<br>
  una vez hecho esto hacemos click sobre el boton de la parte inferior que dice "Iniciar ping" para comenzar.<br>
  ![Manual_Usuario_PingIPPaso3Real.png](Manual%20de%20usuario%2FManual_Usuario_PingIPPaso3Real.png)<br>
  A continuacion nos mostrara en tiempo real la especificacion del ping realizado a la direccion ip seleccionada.<br>
...
- ### 6.10 Ping a un Rango de IPs
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Ping a un rango de IPs" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.10.1 Ping a un Rango de IPs modo Simulasion
  ...
  queremos hacer el ping para saber si se encuentran activas y le damos click al boton que dice "ping".<br>
  ![Manual_Usuario_PingRangoPaso2Simulasion.png](Manual%20de%20usuario%2FManual_Usuario_PingRangoPaso2Simulasion.png)<br>
  Esto nos mostrara una ventana como la siguiente que indicara si cada ip especificada se encuentra activa o
  inactiva.<br>
...
- ### 6.10.2 Ping a un Rango de IPs modo Real
  ...
  deseamos que se haga un ping de las ips entre estas.<br>
  ...
  A continuacion nos mostrara en tiempo real si cada ip entre ese rango se encuentra activa o inactiva.<br>
  ![Manual_Usuario_PingRangoPaso4Real.png](Manual%20de%20usuario%2FManual_Usuario_PingRangoPaso4Real.png)<br>

- ### 6.11 Mapa de Estado de la Red
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Mapa de estado de la red" en el lado derecho de la ventana como indica la siguiente imagen.<br>
...
- ### 6.12 Problemas de Conexión
  Una vez abierta la aplicacion y con la interfaz grafica de usuario a la vista lo primero que debemos hacer es apretar
  el boton que dice
  "Problemas de conexion" en el lado derecho de la ventana como indica la siguiente imagen.<br>
  ...
  deberemos hacer click en el boton que dice "OK.<br>
  ![Manual_Usuario_ProblemasConexionPaso2.png](Manual%20de%20usuario%2FManual_Usuario_ProblemasConexionPaso2.png)<br>
  A continuacion nos mostrara todos los equipos a los que el equipo que seleccionamos puede conectarse.<br>
